  ...
  return (
    <div>
      ...
      <section style={{ marginBottom: "3rem", textAlign: "left" }}>
        ...
        >
          Interactive{" "}
          <span style={{ color: "var(--accent-color)" }}>CLI Companion</span>
        </h1>
        <p
          style={{
            fontSize: "1.2rem",
        ...
        >
          Learn how to master advanced command line tools like Git, local AI
          models (Ollama), multimedia rendering (FFmpeg), high-speed extractors
          (yt-dlp), and python runtime environments.
        </p>
      </section>
        ...
        >
          ...
          >
            ...
            >
              ...
              `&gt;`) to execute bulk transformations that would take hours
              inside a graphical browser window.
            </p>
          </div>
          ...
          >
            ...
            >
              Using tools like Ollama, keep your prompts, coding assistants, and
              document analysis models on your local hard drive. 100% offline,
              zero server usage costs.
            </p>
          </div>
          ...
          >
            ...
            >
              FFmpeg lets you compress gigabytes of raw recording files down to
              high-definition web assets in seconds without uploading data to
              untrustworthy third-party online converters.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          Tools CLI is a community-driven, 100% open-source companion dashboard.
          Feel free to inspect the source code, fork the repository, suggest
          optimizations, or contribute new interactive CLI generators to enhance
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <a
            href="https://github.com/karan-k-code/tools-cli/issues"
            target="_blank"
            rel="noopener noreferrer"
            className="copy-btn"
            style={{
